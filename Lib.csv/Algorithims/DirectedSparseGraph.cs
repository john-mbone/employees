...
namespace Algorithms
{
    public class DirectedSparseGraph<T> : IGraph<T> where T : IComparable<T>
    {
        ...
        protected virtual Dictionary<T, DLinkedList<T>> _adjacencyList { get; set; }//Dictionary of type T=>key Map to LinkedList of Type T,Generics
        ...
        /// </summary>
        public virtual bool RemoveVertex(T vertex)//typeof(Worker)
        {
        ...
        {
            return D_F_S(_firstInsertedNode);
        }
        ...
        /// Returns the visited vertices of the graph.
        /// </summary>
        public virtual IEnumerable<T> D_F_S(T source)
        {
